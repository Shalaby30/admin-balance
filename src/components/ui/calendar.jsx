  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        monthsMode && "months-mode [&_.rdp-table]:hidden [&_.rdp-head]:hidden",
        className
      )}
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-gray-950 shadow-xs has-focus:ring-gray-950/50 has-focus:ring-[3px] relative rounded-md",
        ...
        caption_label: cn("select-none font-medium", captionLayout === "label"
          ? "text-sm"
          : "[&>svg]:text-gray-500 flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-sm [&>svg]:size-3.5", defaultClassNames.caption_label),
        ...
        range_start: cn("bg-gray-100 rounded-l-md", defaultClassNames.range_start),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn("bg-gray-100 rounded-r-md", defaultClassNames.range_end),
        today: cn(
