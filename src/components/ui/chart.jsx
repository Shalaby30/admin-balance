...
const ChartTooltipContent = React.forwardRef((
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-gray-200 border-gray-200/50 bg-white px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}>
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      ...
                      {item.value && (
                        <span
                          className="font-mono font-medium tabular-nums text-gray-950">
